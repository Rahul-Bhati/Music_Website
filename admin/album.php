		...
		<script>
			$(document).ready(function(){
				$(".btn.btn-danger").click(function(){
					...
					//alert(id);
					$.post(
						"matches.php?code=<?php echo $category_code; ?>",{id:id},function(data){
							$("#matches").html(data);
						}
					); 
				});
				...
				$(".fa.fa-edit").click(function(){
					...
					//alert(code+" "+text);
					$.post(
						"action_album.php?category_code=<?php echo $category_code; ?>",{code:code,text:text},function(data){
							//alert(data);
							$("#record").html(data);
						}
					);
				...
				$("#char").keyup(function(){
					...
					//alert(v);
					$.post(
						"search_album.php?category_code=<?php echo $category_code; ?>",{ch:v},function(data){
							//alert(data);
							$("#search").html(data);
						}
					);
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group">
                    <input class="form-control" type="text" id="char" placeholder="Search for..." aria-label="Search for..." aria-describedby="btnNavbarSearch" />
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main id="record">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<?php
										...
										?>
											<h3 class="alert alert-success">Album Added !</h3>
										<?php
										}
										...
										?>
											<h3 class="alert alert-danger">Album Not Added !</h3>
										<?php
										}
										else if(isset($_GET["img_error"])){
										?>
											<h3 class="alert alert-danger">Image Error !</h3>
										<?php
										}
										else if(isset($_GET["usuccess"])){
										?>
											<h3 class="alert alert-danger">Album Updated Successfully !</h3>
										<?php
										}
										else if(isset($_GET["uerror"])){
										?>
											<h3 class="alert alert-danger">Album Not Updated !</h3>
										<?php
										}
										else if(isset($_GET["ump3_error"])){
										?>
											<h3 class="alert alert-danger">Album Update Error !</h3>
										<?php
										}
									?>
											
									<form enctype="multipart/form-data" method="post" action="add_album.php?code=<?php echo $category_code ?>" class="form" >
										<label class="form-label" >Album Name</label>
										<input class="form-control"  type="text" name="album_name" placeholder="album name" required /><br>
										...
										<a><input type="submit" value="add album" class="btn btn-primary"></a><br><br>
									</form>
								</div>
							</div>
						</div>
					...
					<div class="row" >
                        <div class="col-sm-12">
							<div class="container-fluid px-4" id="search">
							<br><br>
								...
								?>
									...
									<?php
										$rs=mysqli_query($conn,"select * from album where category_code='$category_code' AND status='0' AND album_name LIKE 'A%' AND album_name LIKE 'a%'");
